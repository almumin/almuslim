...
class CalculationMethodsWidget extends StatefulWidget {
  final Box box;
  const CalculationMethodsWidget({Key key, this.box}) : super(key: key);

  @override
  State<CalculationMethodsWidget> createState() =>
      _CalculationMethodsWidgetState();
}

class _CalculationMethodsWidgetState extends State<CalculationMethodsWidget> {
              ...
              itemBuilder: (BuildContext context, int index) {
                return new InkWell(
                  ...
                  onTap: () {
                    ...
                    widget.box
                        .put("calculationMethod", calculationMethods[index].id);
                  },
